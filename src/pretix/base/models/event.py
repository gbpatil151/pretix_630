...
class Event(EventMixin, LoggedModel):
    ...
    def copy_data_from(self, other, skip_meta_data=False):
        ...
        builder.copy_items()
        builder.copy_item_meta_values()
        builder.copy_bundles_and_addons()
        builder.copy_quotas()
        builder.copy_discounts()
        builder.copy_questions()
        builder.copy_checkin_lists()
        builder.copy_seating_plans()
        builder.copy_settings()
        builder.emit_signals()
